...
- **詳細**: [docs/specs/26070718-m2_streaming_and_history/spec.md §4.2](docs/specs/26070718-m2_streaming_and_history/spec.md#42-会話の永続化done-一括保存)
...
- **詳細**: [docs/specs/26070718-m2_streaming_and_history/spec.md §4.5](docs/specs/26070718-m2_streaming_and_history/spec.md#45-引用citationsの番号付けとペイロード)
...
- **詳細**: [docs/specs/26070805-m3_eval_expansion/spec.md §3.3](docs/specs/26070805-m3_eval_expansion/spec.md#33-正解の粒度--文書pathレベルchunk_id-を正解に使わない)
...
- **詳細**: [docs/specs/26070805-m3_eval_expansion/spec.md §7.3](docs/specs/26070805-m3_eval_expansion/spec.md#73-ゲート方針検索は硬め生成は柔らかめ)
...
- **詳細**: [docs/specs/26070811-m4_ingestion_and_demo/spec.md §4.2](docs/specs/26070811-m4_ingestion_and_demo/spec.md#42-更新の全置換埋め込みは事前db-反映は短いトランザクション)
...
- **詳細**: [docs/specs/26070811-m4_ingestion_and_demo/spec.md §4.3](docs/specs/26070811-m4_ingestion_and_demo/spec.md#43-削除反映と安全弁)
...
- **詳細**: [docs/specs/26070811-m4_ingestion_and_demo/spec.md §4.4](docs/specs/26070811-m4_ingestion_and_demo/spec.md#44-多重実行の抑止running-行で担保advisory-lock-は開始の原子性のみ)
...
- **詳細**: [docs/specs/26070922-m5_release_readiness/spec.md §12](docs/specs/26070922-m5_release_readiness/spec.md#12-受け入れ条件-definition-of-success-のクローズ) / [docs/specs/26070922-m5_release_readiness/tasklist.md Phase 9](docs/specs/26070922-m5_release_readiness/tasklist.md) / [assets/README.md](assets/README.md)（未実施4項目の引き継ぎ手順）
...
- **詳細**: [docs/specs/26071710-m9_google_drive_ingestion/spec.md §3.4/§4.3](docs/specs/26071710-m9_google_drive_ingestion/spec.md#34-oauth-を使わない)
...
- **詳細**: [docs/specs/26071710-m9_google_drive_ingestion/spec.md §3.2/§4.2](docs/specs/26071710-m9_google_drive_ingestion/spec.md#32-identity-key-の一般化後方互換を維持)
